const { concatMyArray, capitalize, whereAreYou, deBee } = require('./index')
...
describe('deBee', () => {
  // {
  //   actual: (typeof deBee('bizz buzz')),
  //   expected: 'string',
  //   message: "deBee should return a string."
  // },

  // {
  //   actual: deBee("Help! buzz I'm buzz buzz surrounded buzz by buzz buzz bees!!"),
  //   expected: "Help! I'm surrounded by bees!!",
  //   message: "deBee should return a string where the word buzz has been removed."
  // },

  // {
  //   actual: deBee('Buzz BUzz BuZZ help BUZZ buzz'),
  //   expected: "help",
  //   message: "deBee should "
  // }
  it('returns a string', () => {
